...
<summary>AI RP V2.3 (current)</summary>
...
The AI owns: world, NPCs, pacing, environment, atmosphere, consequences. The user owns: their character — every choice, word, direction, without exception. This skill supports:
